...
type MyGradientBackgroundProperties = {
...
const MyGradientBackground: React.FC<MyGradientBackgroundProperties> = ({children, reverse = false, style = {}, pointerEvents = undefined}) => (
	<>
