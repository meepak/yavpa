...
const SimplifySmooth = ({
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', minHeight: 55 }}>
                <MyRadioButtons
            ...
            <View style={{ width: 100, height: 150, position: 'absolute', top: -5, right: -20 }}>
            ...
            <View style={{ width: 100, height: 150,  position: 'absolute', top: -5, right: 40}}>
                <Svg height="100%" width="100%" viewBox={viewBox}>
                    <Path
