...
import ColorBox from "@c/controls/color-box";
import ContextMenu from "@c/controls/context-menu";
import StrokeWidth from "@c/controls/stroke-width";
                    ...
                    <View style={styles.row} key={layer.guid}>
                        ...
                        <TouchableOpacity style={{...styles.cell, width: 100}}>
                            <ContextMenu anchor={<Text style={{ fontSize: 12, }}>{layer.stroke}</Text>} width={350} height={200}>
                                <ColorBox initialColor={layer.stroke} onColorSelected={(color) => updateLayer({ ...layer, stroke: color })} />
                            </ContextMenu>
                        </TouchableOpacity>
